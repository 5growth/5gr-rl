...
public class SliceConfig {
     ...
     */
    public SliceConfig(String nameSlice, String nameVpls, Boolean meter, String meterUnit, Set<String> bands, QueueConfig qos) {
     ...
     *
     * @return a QueueConfig that explain if queue are used
     */
    public QueueConfig qos() {
        return qos;
    }
