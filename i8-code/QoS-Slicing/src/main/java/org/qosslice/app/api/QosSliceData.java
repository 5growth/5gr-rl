...
public class QosSliceData {
    ...
    public static QosSliceData of(QosSliceData qoSData) {
        ...
        if (qoSData.getQueue() != null) {
            qoSData.setQueue(qoSData.getQueue().copy());
        }
    ...
    public void addQueue(QueueConfig queue) { this.queue = queue; }
    ...
    public void removeQueue() { this.queue = null; }
