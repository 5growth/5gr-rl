...
from swagger_server.models.nfvi_pops_inner_nfvi_pop_attributes_network_connectivity_endpoint import NfviPopsInnerNfviPopAttributesNetworkConnectivityEndpoint  # noqa: F401,E501
from swagger_server.models.nfvi_pops_inner_nfvi_pop_attributes_resource_zone_attributes import NfviPopsInnerNfviPopAttributesResourceZoneAttributes  # noqa: F401,E501
...
class NfviPopsInnerNfviPopAttributes(Model):
    ...
    def __init__(self, geographical_location_info: str=None, vim_id: str=None, federated_vim_id: str=None, network_connectivity_endpoint: List[NfviPopsInnerNfviPopAttributesNetworkConnectivityEndpoint]=None, nfvi_pop_id: str=None, resource_zone_attributes: List[NfviPopsInnerNfviPopAttributesResourceZoneAttributes]=None):  # noqa: E501
