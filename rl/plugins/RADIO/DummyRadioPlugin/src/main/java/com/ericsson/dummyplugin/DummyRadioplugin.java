...
import com.ericsson.dummyplugin.sbi.DummyRadioIF;
...
public class DummyRadioplugin {
    public static void main(String[] args) {
        ...
        String prompt;
        //Create eventbus
        System.out.println("DUMMY RADIO PLUGIN START");
        EventBus evbus;
...
//        }
        ...
        System.out.println("DUMMY RADIO PLUGIN registering modules ...");

        evbus.register(mtpif);
        evbus.register(new DummyRadioIF());
        ...
        System.out.println("Start DUMMY RADIO PLUGIN feature TEST:");
        while (!onexit) {
