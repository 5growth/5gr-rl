...
import com.ericsson.dummyplugin.nbi.swagger.model.RadioCoverageAreaListInner;
...
import com.ericsson.dummyplugin.sbi.objects.RadioCoverageInfo;
...
public class DummyRadioIF {
    ...
    private List<RadioCoverageInfo> radiocoveragelist;
    ...
    public DummyRadioIF() {
        ...
        radiocoveragelist = new ArrayList();
    ...
    public void handle_ParseDomainList(Parsedomainlist domlist) {
        ...
        radiocoveragelist = xmldom.getRadiocoveragelist();
    ...
    public void handle_FreeVlanRequest(FreeVlanRequest vlanreq) {
        System.out.println("DummyRadioIF ---> free vlan request" );
    ...
    public void handle_ComputeAllocateRequest(ComputeAllocateRequest servallreq) {
        System.out.println("DummyRadioIF ---> allocate compute service request" );
        ...
        compel.setComputeName("DummyRadioCompService" + Integer.toString(netservcounter));
        compel.setFlavourId(compreq.getComputeFlavourId());
        compel.setHostId("DummyRadioHost");
        ...
        virtualCpu.setNumVirtualCpu(Integer.parseInt(cpuel.getNumvcpu())); 
    ...
    public void handle_ComputeTerminateRequest(ComputeTerminateRequest servtermreq) {
        System.out.println("DummyRadioIF ---> terminate compute service request" );
        ...
        System.out.println("DummyRadioIF ---> post ComputeTerminateReply");
        SingletonEventBus.getBus().post(servtermrep);
    }
    
     @Subscribe
    public void handle_ComputeOperateRequest(ComputeOperateRequest compreq) {
        System.out.println("DummyRadioIF ---> compute operate request" );
        ...
        VIMVirtualCompute servel = compservlist.get(compreq.getRequest().getId());
         if (servel != null) {
            ...
            System.out.println("DummyRadioIF ---> post ComputeOperateReply");
    ...
    public AllocateNetworkResult AllocateNetworkData(AllocateNetworkRequest netdatareq) {
        ...
        if (vlanflag == true) {
            System.out.println("DummyRadioIF ---> network for vlan allocation");
            ...
            System.out.println("DummyRadioIF ---> network for vxlan or private allocation");
            System.out.println("DummyRadioIF ---> network for vlan allocation");
    ...
    public AllocateNetworkResult AllocateSubnetData(AllocateNetworkRequest netdatareq) {
        ...
        if (subnetid.compareTo("") ==0) {
            System.out.println("DummyRadioIF ---> error subnet id not found for netid " + netdatareq.getTypeSubnetData().getNetworkId());
            return resp;
        }
    ...
    public AllocateNetworkResult AllocatePortData(AllocateNetworkRequest netdatareq) {
        ...
        if (subnetflag == false) {
            System.out.println("DummyRadioIF ---> error subnet id not found in metadata");
            return resp;
        }
    ...
    public void handle_VirtualNetworkAllocateRequest(VirtualNetworkAllocateRequest servallreq) {
        System.out.println("DummyRadioIF ---> allocate network service request" );
        AllocateNetworkResult resp = new AllocateNetworkResult();
        ...
        VirtualNetworkAllocateReply servallrep = new VirtualNetworkAllocateReply(servallreq.getReqid(),
                    resp);
        System.out.println("DummyRadioIF ---> post VirtualNetworkAllocateReply");
        SingletonEventBus.getBus().post(servallrep);
    ...
    public void handle_VirtualNetworkTerminateRequest(VirtualNetworkTerminateRequest servtermreq) {
        System.out.println("DummyRadioIF ---> terminate network service request" );
        ...
        for ( int i = 0; i < servtermreq.getE2EWIMElem().size(); i++) {
            if (servtermreq.getE2EWIMElem().get(i).contains("datanet") == true) {
                ...
                if (subnetid.compareTo("") == 0) {
                    System.out.println("DummyRadioIF ---> error subnet not found for delete datanet");
                    return;
                } 
                String nettype = nettypemap.get(subnetid);
                if (nettype == null) {
                    System.out.println("DummyRadioIF ---> error nettype not found for delete datanet");
                    return;
                }
                if (nettype.compareTo("VLAN") == 0) {
                    //remove
                    System.out.println("DummyRadioIF ---> remove entry for vlan");
                ...
                if (subnetid.compareTo("") == 0) {
                    System.out.println("DummyRadioIF ---> error subnet not found for delete port");
                    return;
                }
                netportmap.remove(subnetid);
            } else {
                System.out.println("DummyRadioIF ---> no datanet, subnet, port to remove. Nothing to do" );
            }
        ...
        System.out.println("DummyRadioIF ---> post VirtualNetworkTerminateReply");
        SingletonEventBus.getBus().post(servtermrep);
    }    
    ...
    public void handle_ComputeCapacityRequest(ComputeCapacityRequest compcapreq) {
        System.out.println("DummyRadioIF ---> retrieve compute resources capacity for resid = " + compcapreq.getCapacityRequest().getComputeResourceTypeId());
        
        ComputeResource el = compreslist.get(compcapreq.getCapacityRequest().getComputeResourceTypeId());
        
        if (el == null) {
            System.out.println("DummyRadioIF ---> no compute resource found for resid = " + compcapreq.getCapacityRequest().getComputeResourceTypeId());
            ComputeCapacityReply compcaprep = new ComputeCapacityReply(compcapreq.getReqId(),new CapacityInformation());
            System.out.println("DummyRadioIF ---> post NetworkCapacityReply");
    ...
    public void handle_ComputeResourceInformationRequest(ComputeResourceInformationRequest compresreq) {
        System.out.println("DummyRadioIF ---> retrieve network resources");
        ...
        System.out.println("DummyRadioIF ---> post NetworkResourceInformationReply");
        SingletonEventBus.getBus().post(netzonerep);
    }
    
    @Subscribe
    public void handle_ComputeZoneRequest(ComputeZoneRequest netzonereq) {
        System.out.println("DummyRadioIF ---> retrieve zone list");
        ...
        System.out.println("DummyRadioIF ---> post NetworkZoneReply");
        SingletonEventBus.getBus().post(netzonerep);
    }
    
    @Subscribe
    public void handle_NfviPopAbstractionRequest(NfviPopAbstractionRequest nfvipopreq) {
        System.out.println("DummyRadioIF ---> retrieve nfvipop list");
        ...
        System.out.println("DummyRadioIF ---> post NfviPopAbstractionReply");
        SingletonEventBus.getBus().post(nfvipoprep);
        
    }
    
    @Subscribe
    public void handle_RadioCoverageAreaRequest(RadioCoverageAreaRequest covareareq) {
        System.out.println("DummyRadioIF ---> retrieve radio coverage area list");
        InlineResponse2001 response = new InlineResponse2001();
        RadioCoverageAreaList covarealist = new RadioCoverageAreaList();
        
        for (int i = 0; i < radiocoveragelist.size(); i++) {
            RadioCoverageInfo el = radiocoveragelist.get(i);
            RadioCoverageAreaListInner covareael = new RadioCoverageAreaListInner();
            RadioCoverageAreaListInnerRadioCoverageAreaInfo covel = new RadioCoverageAreaListInnerRadioCoverageAreaInfo();
            covel.setCoverageAreaDelay(el.getDelay());
            covel.setCoverageAreaGoegraphicalInfo(el.getGeogrphicalInfo());
            covel.setCoverageAreaId(el.getAreaId());
            covel.setCoverageAreaMaxBandwidth(el.getMaxBw());
            covel.setCoverageAreaMinBandwidth(el.getMinBw());
            LocationInfo locinfo = new LocationInfo();
            locinfo.setAltitude(el.getAltitude());
            locinfo.setLatitude(el.getLatitude());
            locinfo.setLongitude(el.getLongitude());
            locinfo.setRange(el.getRange());
            covel.setLocationInfo(locinfo);
            covareael.setRadioCoverageAreaInfo(covel);
            covarealist.add(covareael);
        }
        response.setRegions(covarealist);
        RadioCoverageAreaReply covarearep = new RadioCoverageAreaReply(covareareq.getReq(), response);
        System.out.println("DummyRadioIF ---> post RadioCoverageAreaReply");
        SingletonEventBus.getBus().post(covarearep);
        
    }
    
    @Subscribe
    public void handle_PNFlistRequest(PNFlistRequest pnfreq) {
        System.out.println("DummyRadioIF ---> retrieve pnf list");
        ...
        System.out.println("DummyRadioIF ---> post PNFlistReply");
    ...
    public void handle_PNFAllocateRequest(PNFAllocateRequest pnfreq) {
        System.out.println("DummyRadioIF ---> allocate pnf");
        ...
        System.out.println("DummyRadioIF ---> post PNFAllocateReply");
        SingletonEventBus.getBus().post(pnfresp);
    ...
    public void handle_PNFTerminateRequest(PNFTerminateRequest pnfreq) {
        System.out.println("DummyRadioIF ---> terminate pnf");
        PNFReply response = new PNFReply();
        if (pnfservlist.remove(pnfreq.getRequest().getPnfResId()) == null) {
            System.out.println("DummyRadioIF ---> no pnf to terminate with key: " + pnfreq.getRequest().getPnfResId());
        }
        ...
        System.out.println("DummyRadioIF ---> post PNFTerminateReply");
        SingletonEventBus.getBus().post(pnfresp);
    ...
    public void handle_MFlistRequest(MFlistRequest mfreq) {
        System.out.println("DummyRadioIF ---> retrieve mf list");
    ...
    public void handle_MFAllocateRequest(MFAllocateRequest mfreq) {
        ...
        System.out.println("DummyRadioIF ---> post MFAllocateReply");
    ...
    public void handle_MFTerminateRequest(MFTerminateRequest mfreq) {
        System.out.println("DummyRadioIF ---> terminate mf");
        ...
        System.out.println("DummyRadioIF ---> post MFTerminateReply");
        SingletonEventBus.getBus().post(mfresp);
