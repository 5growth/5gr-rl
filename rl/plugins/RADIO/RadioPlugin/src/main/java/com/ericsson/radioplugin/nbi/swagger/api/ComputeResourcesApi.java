...
import com.ericsson.radioplugin.nbi.swagger.model.CapacityInformation;
import com.ericsson.radioplugin.nbi.swagger.model.NfviPop;
import com.ericsson.radioplugin.nbi.swagger.model.ResourceZone;
import com.ericsson.radioplugin.nbi.swagger.model.VIMAllocateComputeRequest;
import com.ericsson.radioplugin.nbi.swagger.model.VIMVirtualCompute;
import com.ericsson.radioplugin.nbi.swagger.model.VirtualComputeFlavour;
import com.ericsson.radioplugin.nbi.swagger.model.VirtualComputeResourceInformation;
...
public class ComputeResourcesApi {
    ...
    public Response allocateCompute(@Valid VIMAllocateComputeRequest body) {
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "", notes = "", response = String.class, tags={ "VIMComputeResources",  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "", notes = "", response = Void.class, tags={ "VIMComputeResources",  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "", notes = "", response = CapacityInformation.class, tags={ "VIMComputeResources",  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "", notes = "", response = VirtualComputeResourceInformation.class, responseContainer = "List", tags={ "VIMComputeResources",  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "", notes = "", response = ResourceZone.class, responseContainer = "List", tags={ "VIMComputeResources",  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "", notes = "", response = VirtualComputeFlavour.class, responseContainer = "List", tags={ "VIMComputeResources",  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "", notes = "", response = NfviPop.class, responseContainer = "List", tags={ "VIMComputeResources",  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "", notes = "", response = VIMVirtualCompute.class, responseContainer = "List", tags={ "VIMComputeResources",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Element containing information about the virtual compute resource(s) matching the filter. The cardinality can be 0 if no matching compute resources exist.", response = VIMVirtualCompute.class, responseContainer = "List"),
        @ApiResponse(code = 400, message = "Bad request", response = Void.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = Void.class),
        @ApiResponse(code = 403, message = "Forbidden", response = Void.class)
    })
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "", notes = "", response = String.class, responseContainer = "List", tags={ "VIMComputeResources" })
    @ApiResponses(value = { 
