 ...
 */
package com.ericsson.radioplugin;

import com.ericsson.radioplugin.events.abstraction.Parsedomainlist;
import com.ericsson.radioplugin.events.abstraction.StopServer;
import com.ericsson.radioplugin.nbi.swagger.api.AbstractComputeOperateResourcesApi;
import com.ericsson.radioplugin.nbi.swagger.api.AbstractComputeResourcesApi;
import com.ericsson.radioplugin.nbi.swagger.api.AbstractNetworkApi;
import com.ericsson.radioplugin.nbi.swagger.api.AbstractNetworkResourcesApi;
import com.ericsson.radioplugin.nbi.swagger.api.AbstractRadioCoverageareaApi;
import com.ericsson.radioplugin.nbi.swagger.api.AbstractResourcesApi;
import com.ericsson.radioplugin.nbi.swagger.api.ComputeOperateResourcesApi;
import com.ericsson.radioplugin.nbi.swagger.api.ComputeResourcesApi;
import com.ericsson.radioplugin.nbi.swagger.api.HealthzApi;
import com.ericsson.radioplugin.nbi.swagger.api.InformationApi;
import com.ericsson.radioplugin.nbi.swagger.api.MTPIF;
import com.ericsson.radioplugin.nbi.swagger.api.MecappApi;
import com.ericsson.radioplugin.nbi.swagger.api.NetworkResourcesApi;
import com.ericsson.radioplugin.nbi.swagger.api.QuotasApi;
import com.ericsson.radioplugin.nbi.swagger.api.ReservationsApi;
import com.ericsson.radioplugin.nbi.swagger.api.ServiceApi;
import com.ericsson.radioplugin.nbi.swagger.api.SoftwareImagesApi;
import com.ericsson.radioplugin.sbi.RadioIF;
...
//        boolean stub_en = true; //enable stubmode
        ...
        String prompt;
        //Create eventbus
        System.out.println("RADIO PLUGIN START");
        EventBus evbus;
