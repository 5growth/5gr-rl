...
public class ComputeOperateResourcesApi {
    ...
    public void operateCompute(@Suspended final AsyncResponse ar, @Valid OperateComputeRequest body) {
        //return Response.ok().entity("magic!").build();
        System.out.println("operateCompute ----> operate compute suspended");
        System.out.println("operateCompute ----> Calling post");
        reqid++;
        System.out.println("operateCompute ----> reqid = " + Long.toString(reqid));
        suspended.put(Long.toString(reqid), ar);
        ComputeOperateRequest request = new ComputeOperateRequest(reqid, body);
