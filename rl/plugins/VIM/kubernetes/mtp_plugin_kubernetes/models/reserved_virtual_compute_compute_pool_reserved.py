...
class ReservedVirtualComputeComputePoolReserved(Model):
    ...
    def __init__(self, compute_attributes: ReservedVirtualComputeComputePoolReservedComputeAttributes=None, num_cpu_cores: int=None, num_vc_instances: int=None, virtual_mem_size: float=None, zone_id: str=None):  # noqa: E501
        """ReservedVirtualComputeComputePoolReserved - a model defined in Swagger

        :param compute_attributes: The compute_attributes of this ReservedVirtualComputeComputePoolReserved.  # noqa: E501
        :type compute_attributes: ReservedVirtualComputeComputePoolReservedComputeAttributes
        :param num_cpu_cores: The num_cpu_cores of this ReservedVirtualComputeComputePoolReserved.  # noqa: E501
        :type num_cpu_cores: int
        :param num_vc_instances: The num_vc_instances of this ReservedVirtualComputeComputePoolReserved.  # noqa: E501
        :type num_vc_instances: int
        :param virtual_mem_size: The virtual_mem_size of this ReservedVirtualComputeComputePoolReserved.  # noqa: E501
        :type virtual_mem_size: float
        :param zone_id: The zone_id of this ReservedVirtualComputeComputePoolReserved.  # noqa: E501
        :type zone_id: str
        """
        self.swagger_types = {
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'ReservedVirtualComputeComputePoolReserved':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The ReservedVirtualCompute_computePoolReserved of this ReservedVirtualComputeComputePoolReserved.  # noqa: E501
    ...
    def compute_attributes(self) -> ReservedVirtualComputeComputePoolReservedComputeAttributes:
        """Gets the compute_attributes of this ReservedVirtualComputeComputePoolReserved.


        :return: The compute_attributes of this ReservedVirtualComputeComputePoolReserved.
    ...
    def compute_attributes(self, compute_attributes: ReservedVirtualComputeComputePoolReservedComputeAttributes):
        """Sets the compute_attributes of this ReservedVirtualComputeComputePoolReserved.


        :param compute_attributes: The compute_attributes of this ReservedVirtualComputeComputePoolReserved.
        :type compute_attributes: ReservedVirtualComputeComputePoolReservedComputeAttributes
        """
    ...
    def num_cpu_cores(self) -> int:
        """Gets the num_cpu_cores of this ReservedVirtualComputeComputePoolReserved.

        Number of CPU cores that have been reserved.  # noqa: E501

        :return: The num_cpu_cores of this ReservedVirtualComputeComputePoolReserved.
        :rtype: int
        """
    ...
    def num_cpu_cores(self, num_cpu_cores: int):
        """Sets the num_cpu_cores of this ReservedVirtualComputeComputePoolReserved.

        Number of CPU cores that have been reserved.  # noqa: E501

        :param num_cpu_cores: The num_cpu_cores of this ReservedVirtualComputeComputePoolReserved.
        :type num_cpu_cores: int
        """
    ...
    def num_vc_instances(self) -> int:
        """Gets the num_vc_instances of this ReservedVirtualComputeComputePoolReserved.

        Number of virtual container instances that have been reserved.  # noqa: E501

        :return: The num_vc_instances of this ReservedVirtualComputeComputePoolReserved.
        :rtype: int
        """
    ...
    def num_vc_instances(self, num_vc_instances: int):
        """Sets the num_vc_instances of this ReservedVirtualComputeComputePoolReserved.

        Number of virtual container instances that have been reserved.  # noqa: E501

        :param num_vc_instances: The num_vc_instances of this ReservedVirtualComputeComputePoolReserved.
        :type num_vc_instances: int
        """
    ...
    def virtual_mem_size(self) -> float:
        """Gets the virtual_mem_size of this ReservedVirtualComputeComputePoolReserved.

        Size of virtual memory that has been reserved.  # noqa: E501

        :return: The virtual_mem_size of this ReservedVirtualComputeComputePoolReserved.
        :rtype: float
        """
    ...
    def virtual_mem_size(self, virtual_mem_size: float):
        """Sets the virtual_mem_size of this ReservedVirtualComputeComputePoolReserved.

        Size of virtual memory that has been reserved.  # noqa: E501

        :param virtual_mem_size: The virtual_mem_size of this ReservedVirtualComputeComputePoolReserved.
        :type virtual_mem_size: float
        """
    ...
    def zone_id(self) -> str:
        """Gets the zone_id of this ReservedVirtualComputeComputePoolReserved.
        ...
        :return: The zone_id of this ReservedVirtualComputeComputePoolReserved.
        :rtype: str
        """
    ...
    def zone_id(self, zone_id: str):
        """Sets the zone_id of this ReservedVirtualComputeComputePoolReserved.

        References the resource zone where the virtual compute resources have been reserved. Cardinality can be 0 to cover the case where reserved compute resources are not bound to a specific resource zone.  # noqa: E501

        :param zone_id: The zone_id of this ReservedVirtualComputeComputePoolReserved.
        :type zone_id: str
        """
        if zone_id is None:
