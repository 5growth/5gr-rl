...
class AllocateComputeRequest(Model):
    ...
    def __init__(self, affinity_or_anti_affinity_constraints: List[AllocateComputeRequestAffinityOrAntiAffinityConstraints]=None, compute_flavour_id: str=None, compute_name: str=None, interface_data: List[AllocateComputeRequestInterfaceData]=None, location_constraints: str=None, metadata: List[MetaDataInner]=None, reservation_id: str=None, resource_group_id: str=None, user_data: AllocateComputeRequestUserData=None, vc_image_id: str=None):  # noqa: E501
        ...
        :param compute_flavour_id: The compute_flavour_id of this AllocateComputeRequest.  # noqa: E501
        :type compute_flavour_id: str
        :param compute_name: The compute_name of this AllocateComputeRequest.  # noqa: E501
        :type compute_name: str
        :param interface_data: The interface_data of this AllocateComputeRequest.  # noqa: E501
        :type interface_data: List[AllocateComputeRequestInterfaceData]
        :param location_constraints: The location_constraints of this AllocateComputeRequest.  # noqa: E501
        :type location_constraints: str
        :param metadata: The metadata of this AllocateComputeRequest.  # noqa: E501
        :type metadata: List[MetaDataInner]
        :param reservation_id: The reservation_id of this AllocateComputeRequest.  # noqa: E501
        :type reservation_id: str
        :param resource_group_id: The resource_group_id of this AllocateComputeRequest.  # noqa: E501
        :type resource_group_id: str
        :param user_data: The user_data of this AllocateComputeRequest.  # noqa: E501
    ...
    def from_dict(cls, dikt) -> 'AllocateComputeRequest':
        ...
        :param dikt: A dict.
        :type: dict
        :return: The AllocateComputeRequest of this AllocateComputeRequest.  # noqa: E501
        :rtype: AllocateComputeRequest
        """
        return util.deserialize_model(dikt, cls)

    @property
    def affinity_or_anti_affinity_constraints(self) -> List[AllocateComputeRequestAffinityOrAntiAffinityConstraints]:
        """Gets the affinity_or_anti_affinity_constraints of this AllocateComputeRequest.
        ...
        :return: The affinity_or_anti_affinity_constraints of this AllocateComputeRequest.
    ...
    def affinity_or_anti_affinity_constraints(self, affinity_or_anti_affinity_constraints: List[AllocateComputeRequestAffinityOrAntiAffinityConstraints]):
        """Sets the affinity_or_anti_affinity_constraints of this AllocateComputeRequest.

        A list of elements with affinity or anti affinity information of the virtualised compute resource to allocate. There should be a relation between the constraints defined in the different elements of the list.  # noqa: E501

        :param affinity_or_anti_affinity_constraints: The affinity_or_anti_affinity_constraints of this AllocateComputeRequest.
        :type affinity_or_anti_affinity_constraints: List[AllocateComputeRequestAffinityOrAntiAffinityConstraints]
        """
    ...
    def compute_flavour_id(self) -> str:
        """Gets the compute_flavour_id of this AllocateComputeRequest.
        ...
        :return: The compute_flavour_id of this AllocateComputeRequest.
        :rtype: str
        """
    ...
    def compute_flavour_id(self, compute_flavour_id: str):
        """Sets the compute_flavour_id of this AllocateComputeRequest.

        Identifier of the Compute Flavour that provides information about the particular memory, CPU and disk resources for virtualised compute resource to allocate. The Compute Flavour is created with Create Compute Flavour operation  # noqa: E501

        :param compute_flavour_id: The compute_flavour_id of this AllocateComputeRequest.
        :type compute_flavour_id: str
        """
    ...
    def compute_name(self) -> str:
        """Gets the compute_name of this AllocateComputeRequest.
        ...
        :return: The compute_name of this AllocateComputeRequest.
        :rtype: str
        """
    ...
    def compute_name(self, compute_name: str):
        """Sets the compute_name of this AllocateComputeRequest.

        Name provided by the consumer for the virtualised compute resource to allocate. It can be used for identifying resources from consumer side.  # noqa: E501

        :param compute_name: The compute_name of this AllocateComputeRequest.
        :type compute_name: str
        """
    ...
    def interface_data(self) -> List[AllocateComputeRequestInterfaceData]:
        """Gets the interface_data of this AllocateComputeRequest.

        The data of network interfaces which are specific to a Virtual Compute Resource instance.  # noqa: E501

        :return: The interface_data of this AllocateComputeRequest.
    ...
    def interface_data(self, interface_data: List[AllocateComputeRequestInterfaceData]):
        """Sets the interface_data of this AllocateComputeRequest.

        The data of network interfaces which are specific to a Virtual Compute Resource instance.  # noqa: E501

        :param interface_data: The interface_data of this AllocateComputeRequest.
        :type interface_data: List[AllocateComputeRequestInterfaceData]
        """
    ...
    def location_constraints(self) -> str:
        """Gets the location_constraints of this AllocateComputeRequest.
        ...
        :return: The location_constraints of this AllocateComputeRequest.
        :rtype: str
        """
    ...
    def location_constraints(self, location_constraints: str):
        """Sets the location_constraints of this AllocateComputeRequest.

        If present, it defines location constraints for the resource(s) is (are) requested to be allocated, e.g. in what particular Resource Zone.  # noqa: E501

        :param location_constraints: The location_constraints of this AllocateComputeRequest.
        :type location_constraints: str
        """
    ...
    def metadata(self) -> List[MetaDataInner]:
        """Gets the metadata of this AllocateComputeRequest.

        The binary software image file.  # noqa: E501

        :return: The metadata of this AllocateComputeRequest.
    ...
    def metadata(self, metadata: List[MetaDataInner]):
        """Sets the metadata of this AllocateComputeRequest.

        The binary software image file.  # noqa: E501

        :param metadata: The metadata of this AllocateComputeRequest.
        :type metadata: List[MetaDataInner]
        """
        if metadata is None:
    ...
    def reservation_id(self) -> str:
        """Gets the reservation_id of this AllocateComputeRequest.
        ...
        :return: The reservation_id of this AllocateComputeRequest.
        :rtype: str
        """
    ...
    def reservation_id(self, reservation_id: str):
        """Sets the reservation_id of this AllocateComputeRequest.

        Identifier of the resource reservation applicable to this virtualised resource management operation. Cardinality can be 0 if no resource reservation was used.  # noqa: E501

        :param reservation_id: The reservation_id of this AllocateComputeRequest.
        :type reservation_id: str
        """
    ...
    def resource_group_id(self) -> str:
        """Gets the resource_group_id of this AllocateComputeRequest.
        ...
        :return: The resource_group_id of this AllocateComputeRequest.
        :rtype: str
        """
    ...
    def resource_group_id(self, resource_group_id: str):
        """Sets the resource_group_id of this AllocateComputeRequest.

        Unique identifier of the \"infrastructure resource group\", logical grouping of virtual resources assigned to a tenant within an Infrastructure Domain.  # noqa: E501

        :param resource_group_id: The resource_group_id of this AllocateComputeRequest.
        :type resource_group_id: str
        """
    ...
    def user_data(self) -> AllocateComputeRequestUserData:
        """Gets the user_data of this AllocateComputeRequest.


        :return: The user_data of this AllocateComputeRequest.
    ...
    def user_data(self, user_data: AllocateComputeRequestUserData):
        """Sets the user_data of this AllocateComputeRequest.


        :param user_data: The user_data of this AllocateComputeRequest.
        :type user_data: AllocateComputeRequestUserData
        """
    ...
    def vc_image_id(self) -> str:
        """Gets the vc_image_id of this AllocateComputeRequest.
        ...
        :return: The vc_image_id of this AllocateComputeRequest.
        :rtype: str
        """
    ...
    def vc_image_id(self, vc_image_id: str):
        """Sets the vc_image_id of this AllocateComputeRequest.

        Identifier of the virtualisation container software image (e.g. a virtual machine image). Cardinality can be 0 if an \"empty\" virtualisation container is allocated.   # noqa: E501

        :param vc_image_id: The vc_image_id of this AllocateComputeRequest.
        :type vc_image_id: str
        """
