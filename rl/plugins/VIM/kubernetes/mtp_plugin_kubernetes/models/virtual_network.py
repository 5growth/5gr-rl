...
class VirtualNetwork(Model):
    ...
    def __init__(self, bandwidth: float=None, is_shared: bool=None, network_port: List[AllocateNetworkResultNetworkDataNetworkPort]=None, network_qo_s: List[AllocateNetworkResultNetworkDataNetworkQoS]=None, network_resource_id: str=None, network_resource_name: str=None, network_type: str=None, operational_state: str=None, segment_type: str=None, sharing_criteria: str=None, subnet: List[str]=None, zone_id: str=None):  # noqa: E501
        ...
        :param is_shared: The is_shared of this VirtualNetwork.  # noqa: E501
        :type is_shared: bool
        :param network_port: The network_port of this VirtualNetwork.  # noqa: E501
        :type network_port: List[AllocateNetworkResultNetworkDataNetworkPort]
        :param network_qo_s: The network_qo_s of this VirtualNetwork.  # noqa: E501
        :type network_qo_s: List[AllocateNetworkResultNetworkDataNetworkQoS]
        :param network_resource_id: The network_resource_id of this VirtualNetwork.  # noqa: E501
        :type network_resource_id: str
        :param network_resource_name: The network_resource_name of this VirtualNetwork.  # noqa: E501
        :type network_resource_name: str
        :param network_type: The network_type of this VirtualNetwork.  # noqa: E501
        :type network_type: str
        :param operational_state: The operational_state of this VirtualNetwork.  # noqa: E501
        :type operational_state: str
        :param segment_type: The segment_type of this VirtualNetwork.  # noqa: E501
        ...
        self.swagger_types = {
            'bandwidth': float,
            'is_shared': bool,
            'network_port': List[AllocateNetworkResultNetworkDataNetworkPort],
    ...
    def bandwidth(self) -> float:
        """Gets the bandwidth of this VirtualNetwork.

        Minimum network bandwidth (in Mbps).  # noqa: E501

        :return: The bandwidth of this VirtualNetwork.
        :rtype: float
        """
    ...
    def bandwidth(self, bandwidth: float):
        """Sets the bandwidth of this VirtualNetwork.

        Minimum network bandwidth (in Mbps).  # noqa: E501

        :param bandwidth: The bandwidth of this VirtualNetwork.
        :type bandwidth: float
        """
    ...
    def is_shared(self) -> bool:
        """Gets the is_shared of this VirtualNetwork.

        It defines whether the virtualised network is shared among consumers.  # noqa: E501

        :return: The is_shared of this VirtualNetwork.
        :rtype: bool
        """
    ...
    def is_shared(self, is_shared: bool):
        """Sets the is_shared of this VirtualNetwork.

        It defines whether the virtualised network is shared among consumers.  # noqa: E501

        :param is_shared: The is_shared of this VirtualNetwork.
        :type is_shared: bool
        """
    ...
    @property
    def network_port(self) -> List[AllocateNetworkResultNetworkDataNetworkPort]:
        """Gets the network_port of this VirtualNetwork.

        Element providing information of an instantiated virtual network port.  # noqa: E501

        :return: The network_port of this VirtualNetwork.
        :rtype: List[AllocateNetworkResultNetworkDataNetworkPort]
        """
        return self._network_port

    @network_port.setter
    def network_port(self, network_port: List[AllocateNetworkResultNetworkDataNetworkPort]):
        """Sets the network_port of this VirtualNetwork.

        Element providing information of an instantiated virtual network port.  # noqa: E501

        :param network_port: The network_port of this VirtualNetwork.
        :type network_port: List[AllocateNetworkResultNetworkDataNetworkPort]
        """
    ...
    def network_qo_s(self) -> List[AllocateNetworkResultNetworkDataNetworkQoS]:
        """Gets the network_qo_s of this VirtualNetwork.
        ...
        :return: The network_qo_s of this VirtualNetwork.
    ...
    def network_qo_s(self, network_qo_s: List[AllocateNetworkResultNetworkDataNetworkQoS]):
        """Sets the network_qo_s of this VirtualNetwork.

        Element providing information about Quality of Service attributes that the network shall support. The cardinality can be \"0\" to allow for networks without any specified QoS requirements.  # noqa: E501

        :param network_qo_s: The network_qo_s of this VirtualNetwork.
        :type network_qo_s: List[AllocateNetworkResultNetworkDataNetworkQoS]
        """
    ...
    def network_resource_id(self) -> str:
        """Gets the network_resource_id of this VirtualNetwork.

        Identifier of the virtualised network resource.  # noqa: E501

        :return: The network_resource_id of this VirtualNetwork.
        :rtype: str
        """
    ...
    def network_resource_id(self, network_resource_id: str):
        """Sets the network_resource_id of this VirtualNetwork.

        Identifier of the virtualised network resource.  # noqa: E501

        :param network_resource_id: The network_resource_id of this VirtualNetwork.
        :type network_resource_id: str
        """
    ...
    def network_resource_name(self) -> str:
        """Gets the network_resource_name of this VirtualNetwork.

        Name of the virtualised network resource.  # noqa: E501

        :return: The network_resource_name of this VirtualNetwork.
        :rtype: str
        """
    ...
    def network_resource_name(self, network_resource_name: str):
        """Sets the network_resource_name of this VirtualNetwork.

        Name of the virtualised network resource.  # noqa: E501

        :param network_resource_name: The network_resource_name of this VirtualNetwork.
        :type network_resource_name: str
        """
    ...
    def network_type(self) -> str:
        """Gets the network_type of this VirtualNetwork.
        ...
        :return: The network_type of this VirtualNetwork.
        :rtype: str
        """
    ...
    def network_type(self, network_type: str):
        """Sets the network_type of this VirtualNetwork.

        The type of network that maps to the virtualised network. This list is extensible. Examples are: \"local\", \"vlan\", \"vxlan\", \"gre\", \"l3-vpn\", etc. The cardinality can be \"0\" to cover the case where this attribute is not required to create the virtualised network.  # noqa: E501

        :param network_type: The network_type of this VirtualNetwork.
        :type network_type: str
        """
    ...
    def operational_state(self) -> str:
        """Gets the operational_state of this VirtualNetwork.

        The operational state of the virtualised network.  # noqa: E501

        :return: The operational_state of this VirtualNetwork.
        :rtype: str
        """
    ...
    def operational_state(self, operational_state: str):
        """Sets the operational_state of this VirtualNetwork.

        The operational state of the virtualised network.  # noqa: E501

        :param operational_state: The operational_state of this VirtualNetwork.
        :type operational_state: str
        """
    ...
    def segment_type(self) -> str:
        """Gets the segment_type of this VirtualNetwork.
        ...
        :return: The segment_type of this VirtualNetwork.
        :rtype: str
        """
    ...
    def segment_type(self, segment_type: str):
        """Sets the segment_type of this VirtualNetwork.

        The isolated segment for the virtualised network. For instance, for a \"vlan\" networkType, it corresponds to the vlan identifier; and for a \"gre\" networkType, this corresponds to a gre key. The cardinality can be \"0\" to allow for flat networks without any specific segmentation.  # noqa: E501

        :param segment_type: The segment_type of this VirtualNetwork.
        :type segment_type: str
        """
    ...
    def sharing_criteria(self) -> str:
        """Gets the sharing_criteria of this VirtualNetwork.
        ...
        :return: The sharing_criteria of this VirtualNetwork.
        :rtype: str
        """
    ...
    def sharing_criteria(self, sharing_criteria: str):
        """Sets the sharing_criteria of this VirtualNetwork.

        Only present for shared networks. Indicate the sharing criteria for this network. This criteria might be a list of authorized consumers.  # noqa: E501

        :param sharing_criteria: The sharing_criteria of this VirtualNetwork.
        :type sharing_criteria: str
        """
    ...
    def zone_id(self, zone_id: str):
        """Sets the zone_id of this VirtualNetwork.

        If present, it identifies the Resource Zone where the virtual network resources have been allocated.  # noqa: E501

        :param zone_id: The zone_id of this VirtualNetwork.
        :type zone_id: str
        """
        if zone_id is None:
