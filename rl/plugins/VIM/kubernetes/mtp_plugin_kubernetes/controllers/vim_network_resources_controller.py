...
from sbi.kube_network import KubNetwork


def free_vlan():  # noqa: E501
    """Retrieve free vlan tag from VIM domain

    Retrieve free vlan tag from VIM domain # noqa: E501


    :rtype: List[float]
    """
    vlan_array = KubNetwork().get_free_vlans()
    return vlan_array
...
def vi_mallocate_network(params):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        response = KubNetwork().allocate(params)
    return response
...
def vi_mterminate_networks(networkResourceId):  # noqa: E501
    ...
    response = KubNetwork().terminate(networkResourceId)
    return response
