...
public class E2EComputeTerminateInstance {
    ...
    private ArrayList<ArrayList<String>> mfmatrix;

    public E2EComputeTerminateInstance(long reqid, long servid, ArrayList<Long> domlist, ArrayList<Long> poplist, ComputeTerminateElem computeTermElem, ArrayList<String> vmIdList, ArrayList<ArrayList<String>> mfmatrix) {
        this.reqid = reqid;
        this.servid = servid;
        ...
        this.mfmatrix = mfmatrix;
    }

    public ArrayList<ArrayList<String>> getMfmatrix() {
        return mfmatrix;
    }

    public void setMfmatrix(ArrayList<ArrayList<String>> mfmatrix) {
        this.mfmatrix = mfmatrix;
    }
