 ...
 * @author osboxes
 */
public class PhysicalAllocateReq {
    private long reqid;
    private String servid; //service identifiers 
    private long domid; //id of vim domain to contact
    //private long computeservid;
    private PNFRequest pnfreqreq;
    private long nfvipopid;
    private List<String> mflist;

    public PhysicalAllocateReq(long reqid, String servid, long domid, PNFRequest pnfreqreq, long nfvipopid, List<String> mflist) {
        this.reqid = reqid;
        this.servid = servid;
        this.domid = domid;
        this.pnfreqreq = pnfreqreq;
    ...
    public PNFRequest getPnfreqreq() {
        return pnfreqreq;
    }

    public void setPnfreqreq(PNFRequest pnfreqreq) {
        this.pnfreqreq = pnfreqreq;
    }
