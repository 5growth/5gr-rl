 ...
 * @author ezimbgi
 */
public class ComputeAllocateRadioReply {
    ...
    public ComputeAllocateRadioReply(long reqid, String servid, long domid, boolean outcome, int errorcode, String errormsg, VirtualCompute computereply, long nfvipopid, AllocateComputeRequest allocatecomputerequest) {
        this.reqid = reqid;
        this.servid = servid;
        this.domid = domid;
