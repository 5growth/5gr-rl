...
public class E2EComputeTerminateInstanceOutcome {

    private long reqid;
    private long servid; //service identifiers 
    private List<String> computeIdList;

    public E2EComputeTerminateInstanceOutcome() {
        reqid = 0;
        servid = 0;
    ...
    public E2EComputeTerminateInstanceOutcome(long reqid, long servid, List<String> computeIdList) {
        this.reqid = reqid;
        this.servid = servid;
