...
public class E2ENetworkTerminateRequest {

    private long reqid;
    private long servid; //service identifiers
    private List<String> netServIdList; //List of networkServiceId 

    public E2ENetworkTerminateRequest() {
        reqid = 0;
        servid = 0;
        netServIdList = null;
    }

    public E2ENetworkTerminateRequest(long reqid, long servid, List<String> netServIdList) {
        this.reqid = reqid;
        this.servid = servid;
