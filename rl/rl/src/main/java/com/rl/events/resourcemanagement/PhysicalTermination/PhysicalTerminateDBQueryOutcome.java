 ...
 * @author osboxes
 */
public class PhysicalTerminateDBQueryOutcome {
    private long reqid;
   ...
   // List of Virtual Machine identifiers for which the termination is to be requested 
    ...
    public PhysicalTerminateDBQueryOutcome(long reqid, long servid, long domid, long popid, long abstractpopid, PNFReply pnfreq, PNFReply pnfresp, String vmid) {
        this.reqid = reqid;
        this.servid = servid;
        this.domid = domid;
        this.popid = popid;
