...
public class ComputeTerminateReq {
    ...
    public ComputeTerminateReq(long reqid, long servid, ArrayList<Long> domlist, ArrayList<Long> poplist, ComputeTerminateElem computeTermElem, ArrayList<String> vmIdList, ArrayList<ArrayList<String>> mfmatrix) {
        this.reqid = reqid;
        this.servid = servid;
