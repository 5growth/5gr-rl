 ...
 * @author osboxes
 */
public class PhysicalAllocateVIMReply {
    private long reqid;
    ...
    public PhysicalAllocateVIMReply(long reqid, String servid, long domid, boolean outcome, int errorcode, String errormsg, PNFReply pnfreply, long nfvipopid, PNFRequest pnfrequest) {
        this.reqid = reqid;
        this.servid = servid;
        this.domid = domid;
