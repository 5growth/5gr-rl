 ...
 * @author ezimbgi
 */
public class ComputeTerminateRadioReply {
    private long reqid;
    ...
    public ComputeTerminateRadioReply(long reqid, long servid, List<Long> domIdList, List<Boolean> outcomeList, ArrayList<Long> poplist, List<String> computeIdList, List<Integer> errorcodeList, List<String> errormsgList) {
        this.reqid = reqid;
        this.servid = servid;
