 ...
 * @author osboxes
 */
public class PhysicalTerminateReq {
    private long reqid;
   ...
   // List of Virtual Machine identifiers for which the termination is to be requested 
    ...
    public PhysicalTerminateReq(long reqid, long servid, long domid, long popid, long abstractpopid, PNFReply pnfreq, String vmid, List<String> mflist) {
        this.reqid = reqid;
        this.servid = servid;
        this.domid = domid;
        this.popid = popid;
