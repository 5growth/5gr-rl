...
public class QosPerformanceIsolationReply {
    ...
    public QosPerformanceIsolationReply(long reqid, String servid, long domid, AssignQosQueueRequest qosreq, long nfvipopid) {
        this.reqid = reqid;
        this.servid = servid;
        this.domid = domid;
        this.qosreq = qosreq;
