...
public class AssignQosQueueOnosRequest {
  ...
  public AssignQosQueueOnosRequest sliceId(String sliceId) {
  ...
  **/
  ...
  public AssignQosQueueOnosRequest srcEndpoint(String srcEndpoint) {
  ...
  **/
  ...
  public AssignQosQueueOnosRequest dstEndpoint(String dstEndpoint) {
  ...
  public AssignQosQueueOnosRequest maxCapacity(String maxCapacity) {
  ...
  public AssignQosQueueOnosRequest switchIdentifiers(List<String> switchIdentifiers) {
    this.switchIdentifiers = switchIdentifiers;
    return this;
  }

  public AssignQosQueueOnosRequest addSwitchIdentifiersItem(String switchIdentifiersItem) {
  ...
  **/
  ...
  public AssignQosQueueOnosRequest policy(String policy) {
    this.policy = policy;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AssignQosQueueOnosRequest assignQosQueueOnosRequest = (AssignQosQueueOnosRequest) o;
    return Objects.equals(this.sliceId, assignQosQueueOnosRequest.sliceId) &&
        Objects.equals(this.srcEndpoint, assignQosQueueOnosRequest.srcEndpoint) &&
        Objects.equals(this.dstEndpoint, assignQosQueueOnosRequest.dstEndpoint) &&
        Objects.equals(this.maxCapacity, assignQosQueueOnosRequest.maxCapacity) &&
        Objects.equals(this.switchIdentifiers, assignQosQueueOnosRequest.switchIdentifiers) &&
        Objects.equals(this.policy, assignQosQueueOnosRequest.policy);
  }
